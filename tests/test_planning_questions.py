...
class TestPlanningQuestions(unittest.TestCase):
    def test_budget_capped_to_two(self) -> None:
        ...
        out = evaluate_planning_question_budget(spec, process="fdm", archetype="prismatic", max_questions=2)
    ...
    def test_cnc_machine_mode_assumption(self) -> None:
        ...
        out = evaluate_planning_question_budget(spec, process="cnc", archetype="prismatic", max_questions=2)
